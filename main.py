...
def main(args):
    ...
    epochs = args.epochs
    best_acc = 0.0
    save_path = f'./checkpoints/{model_name}_{dataset_name}.pth'
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_name', type=str, default='CoMakNet_tiny', help='Model name to use.')
    # tissuemnist, pathmnist, chestmnist, dermamnist, octmnist, pneumoniamnist, retinamnist, breastmnist, bloodmnist,
    # organamnist, organcmnist, organsmnist'
    parser.add_argument('--dataset', type=str, default='retinamnist', help='Dataset to use.')
